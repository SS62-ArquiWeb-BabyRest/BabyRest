...
public class BackendApplication {
	...
	public CommandLineRunner mappingDemo(
		...
		return args -> {
			...
			userRepository.save(
					new Usuarios("gmorip", new BCryptPasswordEncoder().encode("UPC2023!"),true,new Date(),
							List.of(
			...
			userRepository.save(
					new Usuarios("crevilla", new BCryptPasswordEncoder().encode("DISEÑOPERU18!"),true,new Date(),
							List.of(
